...
set label 1 "TM MODES" at 0.86,0.83 font ", 30" tc rgb "blue"
set label 2 "TE MODES" at 0.868,0.87 font ", 30" tc rgb "red"

#set label 1 "TM MODES" at 0.875,0.83 font ", 30" tc rgb "blue"
#set label 2 "TE MODES" at 0.883,0.87 font ", 30" tc rgb "red"

set ylabel "{/Symbol w}{/cmmi a}/2{/Symbol p}c" offset -4 font ", 35"
...
#plot for [col=2:11] m using 1:col every ::0::180 with lines linecolor rgb "blue" lw 3 notitle
