program main
! F -o out ../modulos/tipos.f90 ../modulos/mcf_matrices.f95 module_utilities.f95 module_solver.f95 square_lattice_2d.f95
...
! Grid settings
a	= 10.0 				! lattice constant 			[nm]
d_a	= 0.165 			! d/a 						[dimless]
d	= a * d_a 			! thickness of grid veins	[nm]
b	= a - d 			! size of the holes 		[nm]

! Material 1 == "Hole" material:

! mu_r1 = 1.0  			  relative magnetic   permeability
epsr_1 = 1.0 			! relative dielectric permittivity
gam_1   = 1.0/(epsr_1)

! Material 2 == "Grid" material:

! mu_r2 = 1.0             relative magnetic   permeability
epsr_2 = 8.9 			! relative dielectric permittivity
gam_2 = 1.0/(epsr_2)  
...
Nkpoints = 40		! Number of k-points on path:
Nbands = 20				! Unused yet
